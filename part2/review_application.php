<?php
    ...
    $insert_q2 = "VALUES(".$transaction['leave_id'].",".$transaction['route_id'].",".$transaction['curr_node'].",".$transaction['end_post_id'].",".$transaction['start_post_id'].",'".$approval_faculty."','sent for review', '".$_POST['remarks']."', now())";
